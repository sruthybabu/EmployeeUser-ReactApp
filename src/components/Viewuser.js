            ...
            <div className='row'>
                <div className='col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12'>
                   ...
                   {viewlist.map((value,key)=>{
                       ...
                       <div class="card">
  <center><img style={{width:245,hegiht:245}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQg2pGWm9AwsdQF2NIkztGn0jhutbmiULiYDw&usqp=CAU" class="card-img-top" alt="..."/></center>
  <div class="card-body">
    <h5 class="card-title">Name:{value.name}</h5>
    <p class="card-text">User Name:{value.username}</p>
    ...
    <p class="card-text">Comapny:{value.company.name}</p>
